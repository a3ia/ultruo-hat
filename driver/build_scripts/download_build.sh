...
wget -N https://raw.githubusercontent.com/Darmur/ultruo-hat/master/driver/patch_rpi/${PATCH}
...
cp -r linux-${KERNEL_VERSION}+/ linux-${KERNEL_VERSION}-v8-16k+/
...
rm -rf modules-rpi-${KERNEL_VERSION}-ultruo/
mkdir -p modules-rpi-${KERNEL_VERSION}-ultruo/boot/overlays
mkdir -p modules-rpi-${KERNEL_VERSION}-ultruo/lib/modules/${KERNEL_VERSION}+/kernel/sound/soc/codecs/
mkdir -p modules-rpi-${KERNEL_VERSION}-ultruo/lib/modules/${KERNEL_VERSION}-v7+/kernel/sound/soc/codecs/
mkdir -p modules-rpi-${KERNEL_VERSION}-ultruo/lib/modules/${KERNEL_VERSION}-v7l+/kernel/sound/soc/codecs/
